...
// labelNodesWithOrphanedDriverPods marks nodes that still have orphaned ClusterPolicy driver pods
// so the driver upgrade controller can replace them with NVIDIADriver-owned pods.
